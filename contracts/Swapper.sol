...
contract Swapper is ISwapper {
    ...
    /// @param tokenIn The exact amount of WETH9 to receive from the swap.
    /// @param tokenOut The exact amount of WETH9 to receive from the swap.
    /// @param amountIn The exact amount of DAI that will be swapped for WETH9.
    /// @return amountOut The amount of WETH9 received.
    function swapExactInputSingle(address tokenIn, address tokenOut, uint256 amountIn) external override returns (uint256 amountOut) {
    ...
    function swapExactOutputSingle(address tokenIn, address tokenOut, uint256 amountOut, uint256 amountInMaximum) external override returns (uint256 amountIn) {
        // Transfer the specified amount of DAI to this contract.
